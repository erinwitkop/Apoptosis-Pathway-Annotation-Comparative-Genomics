...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_apo3
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_apo3
...
#Use first line of code if in
hmmbuild --informat afa $F/Apo3.hmm $F/Apo3_conserved_domains.fasta
...
hmmsearch $F/Apo3.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > Apo3_CV_search.out
