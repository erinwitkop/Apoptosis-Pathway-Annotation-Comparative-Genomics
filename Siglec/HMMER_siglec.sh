...
hmmbuild $F/siglec.hmm $F/Siglec_CD_cvir_nectin_Cgsiglec1.fasta
...
hmmsearch $F/siglec.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > siglec_CV_search.out
