...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_bcl2
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_bcl2
...
hmmbuild --informat afa $F/Bcl2.hmm $F/Bcl2_conserved_domains.fasta
...
hmmsearch $F/Bcl2.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > Bcl2_CV_search.out
