...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_akt
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_akt
...
hmmsearch $F/Akt.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > Akt_CV_search.out
