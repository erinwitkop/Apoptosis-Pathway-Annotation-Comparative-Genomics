...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_Bcl-xL
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_Bxl-xL
...
hmmbuild --informat afa $F/Bclxl.hmm $F/BClxl_conserved_domains.fasta
#hmmbuild $F/Bclxl.hmm $F/BClxl_conserved_domains.fasta
...
hmmsearch $F/Bclxl.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > BclxL_CV_search.out
