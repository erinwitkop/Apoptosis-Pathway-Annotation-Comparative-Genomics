...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_bik
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_bik
...
hmmbuild --informat afa $F/Bik.hmm $F/Bik_conserved_domains.fasta
...
hmmsearch $F/Bik.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > Bik_CV_search.out
