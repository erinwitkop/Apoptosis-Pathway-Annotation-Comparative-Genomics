...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_p53
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_p53
...
hmmbuild --informat afa $F/p53.hmm $F/p53_conserved_domains.fasta
...
hmmsearch $F/p53.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > p53_CV_search.out
