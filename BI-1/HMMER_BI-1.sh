...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_BI-1
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_BI-1
...
hmmbuild --informat afa $F/BI-1.hmm $F/BI-1_like_conserved_domains.fasta
...
hmmsearch $F/BI-1.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > BI-1_CV_search.out
