...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_TRAIL
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_TRAIL
...
hmmbuild --informat afa $F/TRAIL.hmm $F/TNF_conserved_domains.fasta
...
hmmsearch $F/TRAIL.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > TRAIL_CV_search.out