...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_IFN
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_IFN
...
#hmmbuild --informat afa $F/NUMA.hmm $F/NuMa_conserved_domains.FASTA
hmmbuild $F/IFN.hmm $F/IFN_conserved_domains.fasta
...
hmmsearch $F/IFN.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > IFN_CV_search.out
