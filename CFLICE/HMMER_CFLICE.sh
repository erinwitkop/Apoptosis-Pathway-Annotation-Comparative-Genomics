...
#SBATCH -o /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_output_CFLICE
#SBATCH -e /data3/marine_diseases_lab/erin/HMMER_analysis/HMM_error_CFLICE
...
#Use first line of code if in mfasta format from conserved domains
hmmbuild --informat afa $F/CFLICE.hmm $F/CFLIP_conserved.fasta
#hmmbuild $F/NUMA.hmm $F/NUMA_besthits_SMARTBLAST_combined_clustalw.out
...
hmmsearch $F/CFLICE.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > CFLICE_CV_search.out
