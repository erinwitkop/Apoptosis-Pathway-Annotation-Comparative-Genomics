...
hmmbuild --informat afa $F/Bim.hmm $F/Bim_Nterminus.fasta
...
hmmsearch $F/Bim.hmm /data3/marine_diseases_lab/shared/GCF_002022765.2_C_virginica-3.0_protein.faa > Bim_CV_search.out
